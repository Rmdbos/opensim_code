...
class stat_kine_file:
    ...
    def __init__(self, abd_angle, sh_flex_angle, el_flex_angle, setup_path):
    ...
    # shoulder_elv is limited to between -30 and 84 degrees as that is the maximum input for the model
    # elbow_flexion is limited to between 5 and 140 degrees as that is the maximum input for the model
    ...
    # elv_angle angle used for DAS3 in radians. Type: double
    # shoulder_elv angle used for DAS3 in radians. Type: double
    # elv_angley angle used for DAS3 in radians. Type: double
    # elbow_flexion angle used for DAS3 in radians. Type: double
